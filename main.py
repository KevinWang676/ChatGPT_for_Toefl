...
# 请填写您的session_token，可在ChatGPT中找到，详见第一期视频
...
tkinter.Button(root, text='开始语音输入', command=lambda :thread_it(run,)).pack()
root.mainloop()
...
tts.save(str(a) + 'hello.mp3')
# Play the audio
mixer.init()
mixer.music.load(str(a) + "hello.mp3")
mixer.music.play()
